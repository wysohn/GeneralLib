...
public class Area{
    ...
    public String toString() {
        return smallest.world+"@"+smallest.x+","+smallest.y+","+smallest.z+","+largest.x+","+largest.y+","+largest.z;
    }
    ...
    public static Area fromString(String str) {
        ...
        return new Area(new SimpleLocation(world, smallX, smallY, smallZ), new SimpleLocation(world, largeX, largeY, largeZ));
    }

    /**
     * Check wether the area1 and area2 conflicts. Conflict means at least a block in
     * the area is duplicating with another block in the second area.
     *
     * @param area1 area1
     * @param area2 area2
