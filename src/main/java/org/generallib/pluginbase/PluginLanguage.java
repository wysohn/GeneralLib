...
/*
		...
		for(int i = 0;i < strings.size(); i++){
			...
			if(str.contains("${")){
				...
				while(!((start = str.indexOf("${")) == -1 ||
					...
					case "dbtype":
						String dbTypes = "[";
						for(Entry<Class<? extends PluginManager>, PluginManager> entry : base.pluginManagers.entrySet()){
	 ...
	 * It is also expected to get registered in {@link PluginLanguage} using registerLanguage() method.
	 * @author wysohn
	 *
	 */
