    ...
    private JsonMessagePlain[] toJsonMessage(Message[] messages) {
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (message.click_SuggestCommand != null) {
                json.setClickEvent(
                        new JsonMessageClickEvent(ClickAction.suggest_command, message.click_SuggestCommand));
            }
            ...
            if (message.hover_ShowAchievement != null) {
                json.setHoverEvent(
                        new JsonMessageHoverEvent(HoverAction.show_achievement, message.hover_ShowAchievement));
            }
