...
public class VolatileTaskManager extends PluginManager<PluginBase> implements Listener{
    ...
    public VolatileTaskManager(PluginBase base, int loadPriority) {
    ...
    private class DelayedTask extends BukkitRunnable{
        ...
        private VolatileTaskManager getOuterType() {
            return VolatileTaskManager.this;
        }
